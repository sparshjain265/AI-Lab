...
class GA :
	...
	def geneticAlgorithm(self, epoch):
		...
		plt.legend()
		plt.savefig("randomSearch/" + "P" + str(self.populationSize) + "C" + str(self.crossover_prob) + "M" + str(self.mutation_prob) + "E" + str(epoch) + ".png")
		# plt.show()
		plt.close()
...
m = 0
c = 0
# epoch is always 1 for random search
e = 1
for n in N:
	g = GA(n, m, c)
